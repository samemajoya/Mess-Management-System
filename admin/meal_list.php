	...
	<div>
		...
		<main>
			...
			<div>
     		...
     		<main>
			<!-- Meal count -->
		<section id="list3" class="bg-light">
		...
		<!-- Meal count -->
		<center> <button class="btn btn-lg btn-success" onclick="window.open('meal_entry.php')"
						class="request-callback"> Add Meal </button> </center>	
		</section>
		</main>
