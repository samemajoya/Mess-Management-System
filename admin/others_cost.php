<?php
  ...
  if(isset($_POST['save'])){
    $query = "INSERT INTO others_expense VALUES
    (null,'$_POST[user_id]','$_POST[date]','$_POST[purchase]','$_POST[amount2]')";
...
<body>
	<div>
        ...
        <div class="col-md-1"></div>
        	...
        	<center> <h3> Others Cost </h3> </center>
        		<form action="" method="post">
			        ...
			        <div class="form-group">
			         ...
			         <div class="form-group">
			           <label> Amount: </label>
			           <input type="text" name="amount2" class="form-control" required>
			        </div>
